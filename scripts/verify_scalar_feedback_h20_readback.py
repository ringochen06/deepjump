#!/usr/bin/env python
"""Verify exact scalar-feedback H20 OBS readbacks and recompute their decision."""
...
from scripts.adjudicate_scalar_feedback_h20 import adjudicate
...
def verify(
    ...
    *,
    ...
    recomputed_decision = adjudicate(
        ...
        root / "h6_decision.json",
        root / "h6_readback_completion.json",
    )
    ...
    expected_summary = {
        ...
        "h6_decision_sha256": archived_decision["h6_decision_sha256"],
        "h6_completion_sha256": archived_decision["h6_completion_sha256"],
    ...
    if phase == "completion":
        ...
        for name, report in reports.items():
            ...
            expected_report = {
                "status": "SCALAR_FEEDBACK_H20_READBACK_PASS",
                "phase": "initial",
